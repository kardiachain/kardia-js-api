  ...
  return {
    ...
    send: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(privateKey, contractAddress) {
        ...
        var api, senderAccount, accountNonce, gas, gasPrice, tx, signedTx, rawResult, events, result;
    ...
    call: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(sender, contractAddress) {
        var txPayload = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        var api, callObject, result, outputTypes, outputBuffer, decodeResult, rawOutput;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                rawOutput = decodeResult.map(function (decode, index) {
                  if (outputTypes[index].startsWith('byte') && !outputTypes[index].endsWith(']')) {
                    return decode.toString('hex');
                  }
                  return decode.toString();
                });
                return _context3.abrupt('return', (0, _abi.decodeOutput)(functionFromAbi.outputs, rawOutput));
