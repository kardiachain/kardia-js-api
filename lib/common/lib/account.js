...
var makeSigner = function makeSigner(addToV) {
  return function (hash, privateKey) {
    ...
    return encodeSignature([_nat2.default.fromString(_bytes2.default.fromNumber(addToV + signature.recoveryParam)), _bytes2.default.pad(32, _bytes2.default.fromNat('0x' + signature.r.toString(16))), _bytes2.default.pad(32, _bytes2.default.fromNat('0x' + signature.s.toString(16)))]);
  };
};
